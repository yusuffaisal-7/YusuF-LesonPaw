          ...
          <div className="bg-gray-50 rounded-3xl p-8 md:p-12 shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <h3 className="text-3xl font-bold text-gray-900 mb-6">{translate('contactSupport')}</h3>
              ...
              >
                ...
                <form onSubmit={handleSendMessage} className="space-y-6">
                  ...
                  <div className="text-center space-y-6">
                    <h4 className="text-xl font-semibold text-gray-900">{translate('signInToMessage')}</h4>
                    <p className="text-gray-600">{translate('pleaseLoginMessage')}</p>
                    <Link
                      to="/login"
